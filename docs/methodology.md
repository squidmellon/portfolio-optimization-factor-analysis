...
The portfolio reports mean monthly return, sample monthly standard deviation, skewness, excess kurtosis, and Jarque-Bera normality-test p-values. 
...
## Annualization
Monthly volatility was annualized by multiplying by the square root of 12. Sharpe ratios use consistently annualized returns, volatility, and risk-free rates.
